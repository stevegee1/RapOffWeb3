...
extension ExampleViewModel {
    ...
    func writeContractMethod2(contractAddress: String, methodName: String, fromAddress: String) async throws {
           // Create a web3 instance
           guard let url = URL(string: "https://rpc.testnet.mantle.xyz/") else { return }
        let privateKeyString = "0x5e2f1327a7bd0e106c9bb265dbe362aef5144f1e5525deb07f729deae7e63b1d"
           ...
           if let fileURL = Bundle.main.url(forResource: "MyContractABI", withExtension: "json") {
               do {
                   ...
                   if let jsonString = String(data: jsonData, encoding: .utf8) {
                       ...
                       let writeOp = contract.createWriteOperation(methodName, parameters: ["Cuzin"])!
