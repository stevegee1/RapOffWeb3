...
//                            let signer = ExampleViewModel.UserAuthenticationSigningProvider(walletConnect: viewModel.walletConnect!)
                            ...
                            let thirdr = try await viewModel.writeContractMethod2(contractAddress: "0xa9723980a081Ee43A851229C083029FD6eC58635", methodName: "setRapper", fromAddress: "\(viewModel.walletAccount!)")
                            print(thirdr)
