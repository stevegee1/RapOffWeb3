...
// File @openzeppelin/contracts/utils/Counters.sol@v4.9.1
...
// File hardhat/console.sol@v2.14.1
...
contract VotingContract is Ownable, Betting {
    ...
    function voteNow(address _rapperID, string memory _name)
        public
        payable
    //string memory _image,
    // string memory _ipfs,
...
// File contracts/flattenedContract.sol
